...
let g:colors_name = 'poisongeddon'
...
hi Directory ctermfg=156 ctermbg=NONE cterm=NONE guifg=#547E64 guibg=NONE gui=NONE
...
hi VertSplit ctermfg=97 ctermbg=NONE cterm=NONE guifg=#547E64 guibg=NONE gui=NONE
...
hi IncSearch ctermfg=16 ctermbg=119 cterm=bold guifg=#000000 guibg=#547E64 gui=bold
...
hi Normal ctermfg=252 ctermbg=NONE cterm=NONE guifg=#ccd2d9 guibg=#2E222F gui=NONE
hi NormalFloat ctermfg=252 ctermbg=16 cterm=NONE guifg=#ccd2d9 guibg=#3b3847 gui=NONE
hi Pmenu ctermfg=119 ctermbg=16 cterm=NONE guifg=#547E64 guibg=#2c2d2f gui=NONE
hi PmenuSel ctermfg=16 ctermbg=119 cterm=NONE guifg=#000000 guibg=#92A984ONE
hi PmenuSbar ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=#2c2a35 gui=NONE
hi PmenuThumb ctermfg=NONE ctermbg=119 cterm=NONE guifg=NONE guibg=#905EA9 gui=NONE
hi Question ctermfg=119 ctermbg=NONE cterm=underline guifg=#905EA9 guibg=NONE gui=underline
hi Search ctermfg=16 ctermbg=75 cterm=bold guifg=#000000 guibg=#905EA9 gui=bold
...
hi StatusLine ctermfg=63 ctermbg=16 cterm=NONE guifg=#625565 guibg=#547E64 gui=NONE
hi StatusLineNC ctermfg=240 ctermbg=16 cterm=NONE guifg=#905EA9 guibg=#292929 gui=NONE
hi TabLine ctermfg=102 ctermbg=16 cterm=NONE guifg=#2E222F guibg=#547E64 gui=NONE
hi TabLineFill ctermfg=102 ctermbg=16 cterm=NONE guifg=#a1a0ad guibg=NONE gui=NONE
hi TabLineSel ctermfg=63 ctermbg=NONE cterm=NONE guifg=#625565 guibg=#92A984 gui=NONE
hi Title ctermfg=168 ctermbg=NONE cterm=bold guifg=#0EAF9B guibg=NONE gui=bold
hi Visual ctermfg=NONE ctermbg=97 cterm=bold guifg=#000000 guibg=#905EA9 gui=bold
...
"}}}
" Syntax highlighting"{{{
hi Comment ctermfg=102 ctermbg=NONE cterm=NONE guifg=#625565 guibg=NONE gui=NONE
hi Constant ctermfg=208 ctermbg=NONE cterm=NONE guifg=#FB6B1D guibg=NONE gui=NONE
hi String ctermfg=183 ctermbg=NONE cterm=NONE guifg=#4D65B4 guibg=NONE gui=NONE
...
hi Identifier ctermfg=75 ctermbg=NONE cterm=NONE guifg=#4D9BE6 guibg=NONE gui=NONE
hi Function ctermfg=156 ctermbg=NONE cterm=NONE guifg=#92A984 guibg=NONE gui=NONE
hi Statement ctermfg=63 ctermbg=NONE cterm=NONE guifg=#F04F78 guibg=NONE gui=NONE
hi Type ctermfg=75 ctermbg=NONE cterm=NONE guifg=#905EA9 guibg=NONE gui=NONE
hi Special ctermfg=208 ctermbg=NONE cterm=NONE guifg=#FB6B1D guibg=NONE gui=NONE
...
hi DiagnosticInfo ctermfg=24 ctermbg=NONE cterm=NONE guifg=#4D9BE6 guibg=#162c2e gui=NONE
