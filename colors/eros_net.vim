...
hi CursorColumn ctermfg=NONE ctermbg=235 cterm=NONE guifg=NONE guibg=#2D343F gui=NONE
hi CursorLine ctermfg=NONE ctermbg=235 cterm=NONE guifg=NONE guibg=#2D343F gui=NONE
...
hi IncSearch ctermfg=16 ctermbg=119 cterm=bold guifg=#000000 guibg=#9BABB2 gui=bold
hi LineNr ctermfg=240 ctermbg=233 cterm=NONE guifg=#516572 guibg=NONE gui=NONE
...
hi Normal ctermfg=252 ctermbg=NONE cterm=NONE guifg=#ccd2d9 guibg=#1B232B gui=NONE
hi NormalFloat ctermfg=252 ctermbg=16 cterm=NONE guifg=#0cd2d9 guibg=#3b3847 gui=NONE
hi Pmenu ctermfg=119 ctermbg=16 cterm=NONE guifg=#8CD549 guibg=#1B232B gui=NONE
hi PmenuSel ctermfg=16 ctermbg=119 cterm=NONE guifg=#1B232B guibg=#0EAF9B
hi PmenuSbar ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=#2c2a35 gui=NONE
"
hi PmenuThumb ctermfg=NONE ctermbg=119 cterm=NONE guifg=NONE guibg=#0EAF9B gui=NONE 
hi Question ctermfg=119 ctermbg=NONE cterm=underline guifg=#905EA9 guibg=NONE gui=underline
hi Search ctermfg=16 ctermbg=75 cterm=bold guifg=#1B232B guibg=#29465B gui=bold
...
hi StatusLine ctermfg=63 ctermbg=16 cterm=NONE guifg=#625565 guibg=#1B232B gui=NONE
hi StatusLineNC ctermfg=240 ctermbg=16 cterm=NONE guifg=#905EA9 guibg=#1B232B gui=NONE
hi TabLine ctermfg=102 ctermbg=16 cterm=NONE guifg=#516572 guibg=#1B232B gui=NONE
hi TabLineFill ctermfg=102 ctermbg=16 cterm=NONE guifg=#a1a0ad guibg=NONE gui=NONE
hi TabLineSel ctermfg=63 ctermbg=NONE cterm=NONE guifg=#1B232B guibg=#29465B gui=NONE
hi Title ctermfg=168 ctermbg=NONE cterm=bold guifg=#0EAF9B guibg=NONE gui=bold
hi Visual ctermfg=NONE ctermbg=97 cterm=bold guifg=#1B232B guibg=#29465B gui=bold
